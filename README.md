...
- [ ] Fortfarande nere (2026-09-07, samma som tidigare kontroller): Hedemora Energi, Härnösand/HEMAB, Bergs Tingslags Elektriska, Härryda Energi, Jämtkraft - alla TLS-handskakning OK men servern hänger/timeoutar på faktisk data, ingen HTTP-respons alls
- [ ] Falu Elnät: `cust=fev` bekräftat i sidans egen HTML (`webmap.fev.se/outagemap2/?cust=fev&app=fpp`), men KML-endpointen ger fortfarande HTTP 500 - troligen ett serverfel specifikt på den endpointen, inte fel `cust`
- [ ] Nya kandidater hittade men inte verifierade än (ingen uppenbar öppen JSON/API i förstasidans HTML, kräver djupare grävning i deras JS-bundlar): Norrtälje Energi (WordPress), C4 Elnät, Sandviken Energi, Bjärke Energi, Falkenberg Energi (WordPress), Falbygdens Energi (404 på länken från elsamverkan.se, sidan verkar ha flyttat)
