...
- [ ] Vimmerby Energi Nät (VEMAB) `vemab.se/driftstorningar/aktiva-driftstorningar` - 503 vid test, ser annars ut att ha en ren strukturerad sida ("Det finns inga registrerade driftstörningar" när tomt). Njudung Energi (Sävsjö/Vetlanda) har en driftinformation-sida som delar el/fiber/fjärrvärme/vatten - ingen av dem undersökt klart.
